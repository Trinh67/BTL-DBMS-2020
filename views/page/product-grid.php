...
<html class="no-js" lang="">
    ...
    <body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="single-colect banner collect-one">
							<a href="#"><img src="../../public/img/collect/4.jpg" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-4">
						...
						<div class="collect-img banner margin single-colect">
							<a href="#"><img src="../../public/img/collect/5.jpg" alt="" /></a>
						</div>
					</div>
					<div class="col-sm-4">
						<div class="collect-img banner single-colect">
							<a href="#"><img src="../../public/img/collect/6.jpg" alt="" /></a>
						</div>
						<div class="colect-text ">
						...
						<div class="sidebar left-sidebar">
							...
							<div class="s-side-text">
								<div class="banner clearfix">
									<a href="#"><img src="../../public/img/products/banner.jpg" alt="" /></a>
								...
								<div class="tab-content grid-content">
									<div class="tab-pane fade in active text-center" id="grid">
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													...
													<a href="#"><img src="../../public/img/products/9.jpg" alt="Product Title" /></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													...
													<a href="#"><img src="../../public/img/products/8.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													<a href="#"><img src="../../public/img/products/12.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													<a href="#"><img src="../../public/img/products/13.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													<a href="#"><img src="../../public/img/products/11.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													<a href="#"><img src="../../public/img/products/14.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
										...
										<div class="col-xs-12 col-sm-6 col-md-4">
											<div class="single-product">
												<div class="product-img">
													...
													<a href="#"><img src="../../public/img/products/15.jpg" alt="Product Title" /></a>
													<div class="actions-btn">
														<a href="#"><i class="mdi mdi-cart"></i></a>
														<a href="#" data-toggle="modal" data-target="#quick-view"><i class="mdi mdi-eye"></i></a>
														<a href="#"><i class="mdi mdi-heart"></i></a>
												...
												<div class="quick-image">
														...
														<div class="list-img">
															<div class="product-img tab-content">
																<div class="simpleLens-container tab-pane fade in" id="q-sin-1">
																	...
																	<a class="simpleLens-image" data-lens-image="../../public/img/products/z1.jpg" href="#"><img src="../../public/img/products/z1.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
																<div class="simpleLens-container tab-pane active fade in" id="q-sin-2">
																	<div class="pro-type sell">
																		<span>sell</span>
																	</div>
																	<a class="simpleLens-image" data-lens-image="../../public/img/products/z2.jpg" href="#"><img src="../../public/img/products/z2.jpg" alt="" class="simpleLens-big-image"></a>
																</div>
													...
													<div class="quick-thumb">
														<ul class="product-slider">
															<li><a data-toggle="tab" href="#q-sin-1"> <img src="../../public/img/products/s1.jpg" alt="quick view" /> </a></li>
															<li class="active"><a data-toggle="tab" href="#q-sin-2"> <img src="../../public/img/products/s2.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#q-sin-3"> <img src="../../public/img/products/s3.jpg" alt="small image" /> </a></li>
															<li><a data-toggle="tab" href="#q-sin-4"> <img src="../../public/img/products/s4.jpg" alt="small image" /> </a></li>
														</ul>
													</div>
												</div>						
											</div>
		...
		<?php require_once('../include/footer.php') ?>        <!-- footer section end -->
