						...
						<div class="row">
									...
									<div class="footer-text">
										<ul>
											<li>
												...
												<p>ADD 15/2, Hoàng Tăng Bí Stree, Đông Ngạc,</p>
							...
							<div class="col-xs-12 col-sm-3 col-md-2 wide-mobile">
								<div class="single-text">
									...
									<div class="footer-menu">
										<ul>
											<li><a href="login.php"><i class="mdi mdi-menu-right"></i>My Account</a></li>
											<li><a href="wishlist.php"><i class="mdi mdi-menu-right"></i>My Wishlist</a></li>
											<li><a href="cart.php"><i class="mdi mdi-menu-right"></i>My Cart</a></li>
											<li><a href="login.php"><i class="mdi mdi-menu-right"></i>Sign In</a></li>
											<li><a href="checkout.php"><i class="mdi mdi-menu-right"></i>Check out</a></li>
							...
							<div class="col-xs-12 col-sm-3 col-md-2 wide-mobile">
								<div class="single-text">
									...
									<div class="footer-menu">
										<ul>
											<li><a href="contact.php"><i class="mdi mdi-menu-right"></i>New Products</a></li>
